...
// console.log(JSON.stringify([...$0.querySelectorAll("tr td")].map(td => td.innerText), null, 2))
const tds = [
  "3D Crossword Plugin",
  "application/vnd.hzn-3d-crossword",
  ".x3d",
  "IANA: 3D Crossword Plugin",
  "3GP",
  "video/3gpp",
  ".3gp",
  "Wikipedia: 3GP",
  ...
  ".acc",
  "IANA: Active Content Compression",
  "ACU Cobol",
  ...
  ".xdp",
  "Wikipedia: XML Data Package",
  "Adobe XML Forms Data Format",
  "application/vnd.adobe.xfdf",
  ".xfdf",
  "Wikipedia: XML Portable Document Format",
  ...
  ".les",
  "IANA: Archipelago Lesson Player",
  "Arista Networks Software Image",
  "application/vnd.aristanetworks.swi",
  ".swi",
  "IANA: Arista Networks Software Image",
  ...
  "chemical/x-csml",
  ".csml",
  "Wikipedia: Chemical Style Markup Language",
  "CIM Database",
  ...
  ".ait",
  "IANA: Digital Video Broadcasting",
  "Digital Video Broadcasting",
  ...
  ".mlp",
  "IANA: Dolby Meridian Lossless Packing",
  "Doom Video Game",
  "application/x-doom",
  ".wad",
  "Wikipedia: Doom WAD",
  ...
  ".xfdl",
  "IANA: Extensible Forms Description Language",
  ...
  "application/vnd.mif",
  ".mif",
  "IANA: FrameMaker Interchange Format",
  ...
  ".fsc",
  "IANA: Friendly Software Corporation",
  "Frogans Player",
  ...
  ".spl",
  "Wikipedia: FutureSplash Animator",
  "FuzzySheet",
  ...
  ".txd",
  "IANA: Genomatix Tuxedo Framework",
  "GeoGebra",
  ...
  ".gex",
  "IANA: GeoMetry Explorer",
  "GEONExT and JSXGraph",
  "application/vnd.geonext",
  ".gxt",
  "IANA: GEONExT and JSXGraph",
  "GeoplanW",
  ...
  ".bdf",
  "Wikipedia: Glyph Bitmap Distribution Format",
  "GNU Tar Files",
  "application/x-gtar",
  ".gtar",
  "GNU Tar",
  ...
  ".hpid",
  "IANA: Hewlett Packard Instant Delivery",
  "Hewlett-Packard's WebPrintSmart",
  "application/vnd.hp-hps",
  ".hps",
  "IANA: Hewlett-Packard's WebPrintSmart",
  ...
  ".jlt",
  "IANA: HP Job Layout Language",
  "HP Printer Command Language",
  "application/vnd.hp-pcl",
  ".pcl",
  "IANA: HP Printer Command Language",
  "HP-GL/2 and HP RTL",
  "application/vnd.hp-hpgl",
  ".hpgl",
  "IANA: HP-GL/2 and HP RTL",
  "HV Script",
  ...
  ".hvd",
  "IANA: HV Voice Dictionary",
  "HV Voice Parameter",
  "application/vnd.yamaha.hv-voice",
  ".hvp",
  "IANA: HV Voice Parameter",
  "Hydrostatix Master Suite",
  "application/vnd.hydrostatix.sof-data",
  ".sfd-hdstx",
  "IANA: Hydrostatix Master Suite",
  "Hyperstudio",
  ...
  ".i2g",
  "IANA: Interactive Geometry Software",
  ...
  ".xpw",
  "IANA: Intercon FormNet",
  "International Society for Advancement of Cytometry",
  "application/vnd.isac.fcs",
  ".fcs",
  "IANA: International Society for Advancement of Cytometry",
  ...
  ".rcprofile",
  "IANA: IP Unplugged Roaming Client",
  "iRepository / Lucidoc Editor",
  "application/vnd.irepository.package+xml",
  ".irp",
  "IANA: iRepository / Lucidoc Editor",
  "J2ME App Descriptor",
  "text/vnd.sun.j2me.app-descriptor",
  ".jad",
  "IANA: J2ME App Descriptor",
  "Java Archive",
  ...
  ".mmd",
  "IANA: Chipnuts Karaoke",
  "KDE KOffice Office Suite - Karbon",
  "application/vnd.kde.karbon",
  ".karbon",
  "IANA: KDE KOffice Office Suite",
  ...
  ".kne",
  "IANA: Kina Applications",
  "Kodak Storyshare",
  "application/vnd.kodak-descriptor",
  ".sse",
  "IANA: Kodak Storyshare",
  "Laser App Enterprise",
  "application/vnd.las.las+xml",
  ".lasxml",
  "IANA: Laser App Enterprise",
  "LaTeX",
  "application/x-latex",
  ".latex",
  "Wikipedia: LaTeX",
  ...
  ".org",
  "IANA: Lotus Organizer",
  "Lotus Screencam",
  "application/vnd.lotus-screencam",
  ".scm",
  "IANA: Lotus Screencam",
  "Lotus Wordpro",
  ...
  ".nbp",
  "IANA: Mathematica Notebook Player",
  ...
  ".mwf",
  "IANA: Medical Waveform Encoding Format",
  "Melody Format for Mobile Platform",
  "application/vnd.mfmp",
  ".mfm",
  "IANA: Melody Format for Mobile Platform",
  "Mesh Data Type",
  "model/mesh",
  ".msh",
  "RFC 2077",
  ...
  ".cab",
  "IANA: MS Cabinet File",
  "Microsoft Class Server",
  "application/vnd.ms-ims",
  ".ims",
  "IANA: MS Class Server",
  "Microsoft ClickOnce",
  ...
  ".lrm",
  "IANA: MS Learning Resource Module",
  "Microsoft MediaView",
  ...
  ".potx",
  "IANA: OOXML - Presentation Template",
  ...
  ".pya",
  "IANA: Microsoft PlayReady Ecosystem",
  ...
  ".scd",
  "Wikipedia: Microsoft Schedule Plus",
  ...
  ".wpl",
  "IANA: MS Windows Media Player Playlist",
  ...
  ".xbap",
  "Wikipedia: XAML Browser",
  "Microsoft XML Paper Specification",
  "application/vnd.ms-xpsdocument",
  ".xps",
  "IANA: MS XML Paper Specification",
  ...
  ".rms",
  "IANA: Mobile Information Device Profile",
  "MobileTV",
  ...
  ".mbk",
  "IANA: Mobius Management Systems",
  ...
  ".ngdat",
  "IANA: N-Gage Game Data",
  "N-Gage Game Installer",
  "application/vnd.nokia.n-gage.symbian.install",
  ".n-gage",
  "IANA: N-Gage Game Installer",
  ...
  "application/vnd.dna",
  ".dna",
  "IANA: New Moon Liftoff/DNA",
  "NobleNet Directory",
  "application/vnd.noblenet-directory",
  ".nnd",
  "IANA: NobleNet Directory",
  "NobleNet Sealer",
  "application/vnd.noblenet-sealer",
  ".nns",
  "IANA: NobleNet Sealer",
  "NobleNet Web",
  ...
  ".edm",
  "IANA: Novadigm's RADIA and EDM products",
  "Novadigm's RADIA and EDM products",
  ...
  ".dd2",
  "IANA: OMA Download Agents",
  "Open Document Text Web",
  "application/vnd.oasis.opendocument.text-web",
  ".oth",
  "IANA: OpenDocument Text Web",
  "Open eBook Publication Structure",
  "application/oebps-package+xml",
  ".opf",
  "Wikipedia: Open eBook",
  "Open Financial Exchange",
  "application/vnd.intu.qbo",
  ".qbo",
  "IANA: Open Financial Exchange",
  "Open Office Extension",
  "application/vnd.openofficeorg.extension",
  ".oxt",
  "IANA: Open Office Extension",
  "Open Score Format",
  "application/vnd.yamaha.openscoreformat",
  ".osf",
  "IANA: Open Score Format",
  ...
  ".odc",
  "IANA: OpenDocument Chart",
  "OpenDocument Chart Template",
  "application/vnd.oasis.opendocument.chart-template",
  ".otc",
  "IANA: OpenDocument Chart Template",
  "OpenDocument Database",
  "application/vnd.oasis.opendocument.database",
  ".odb",
  "IANA: OpenDocument Database",
  "OpenDocument Formula",
  "application/vnd.oasis.opendocument.formula",
  ".odf",
  "IANA: OpenDocument Formula",
  "OpenDocument Formula Template",
  "application/vnd.oasis.opendocument.formula-template",
  ".odft",
  "IANA: OpenDocument Formula Template",
  "OpenDocument Graphics",
  "application/vnd.oasis.opendocument.graphics",
  ".odg",
  "IANA: OpenDocument Graphics",
  "OpenDocument Graphics Template",
  "application/vnd.oasis.opendocument.graphics-template",
  ".otg",
  "IANA: OpenDocument Graphics Template",
  "OpenDocument Image",
  "application/vnd.oasis.opendocument.image",
  ".odi",
  "IANA: OpenDocument Image",
  "OpenDocument Image Template",
  "application/vnd.oasis.opendocument.image-template",
  ".oti",
  "IANA: OpenDocument Image Template",
  "OpenDocument Presentation",
  "application/vnd.oasis.opendocument.presentation",
  ".odp",
  "IANA: OpenDocument Presentation",
  "OpenDocument Presentation Template",
  "application/vnd.oasis.opendocument.presentation-template",
  ".otp",
  "IANA: OpenDocument Presentation Template",
  "OpenDocument Spreadsheet",
  "application/vnd.oasis.opendocument.spreadsheet",
  ".ods",
  "IANA: OpenDocument Spreadsheet",
  "OpenDocument Spreadsheet Template",
  "application/vnd.oasis.opendocument.spreadsheet-template",
  ".ots",
  "IANA: OpenDocument Spreadsheet Template",
  "OpenDocument Text",
  "application/vnd.oasis.opendocument.text",
  ".odt",
  "IANA: OpenDocument Text",
  "OpenDocument Text Master",
  "application/vnd.oasis.opendocument.text-master",
  ".odm",
  "IANA: OpenDocument Text Master",
  "OpenDocument Text Template",
  "application/vnd.oasis.opendocument.text-template",
  ".ott",
  "IANA: OpenDocument Text Template",
  "OpenGL Textures (KTX)",
  "image/ktx",
  ".ktx",
  "KTX File Format",
  ...
  ".pcf",
  "Wikipedia: Portable Compiled Format",
  ...
  ".pgn",
  "Wikipedia: Portable Game Notationb",
  ...
  ".box",
  "IANA: Preview Systems ZipLock/Vbox",
  "Princeton Video Image",
  "application/vnd.pvi.ptid1",
  ".ptid",
  "IANA: Princeton Video Image",
  ...
  ".str",
  "IANA: Proprietary P&G Standard Reporting System",
  "Proprietary P&G Standard Reporting System",
  ...
  ".qps",
  "IANA: PubliShare Objects",
  "Qualcomm's Plaza Mobile Internet",
  "application/vnd.pmi.widget",
  ".wg",
  "IANA: Qualcomm's Plaza Mobile Internet",
  "QuarkXpress",
  ...
  "application/rsd+xml",
  ".rsd",
  "Wikipedia: Really Simple Discovery",
  "RealMedia",
  ...
  ".snf",
  "Wikipedia: Server Normal Format",
  ...
  ".slt",
  "IANA: SimpleAnimeLite Player",
  "Simply Accounting",
  "application/vnd.accpac.simply.aso",
  ".aso",
  "IANA: Simply Accounting",
  ...
  ".ufd",
  "IANA: Universal Forms Description Language",
  ...
  "application/widget",
  ".wgt",
  "W3C Widget Packaging and XML Configuration",
  "WinHelp",
  "application/winhlp",
  ".hlp",
  "Wikipedia: WinHelp",
...
ok(tds.length % 4 === 0, "td 的数量必须是 4 的整数倍");

const fileTypes = [];
for (let i = 0; i < tds.length; i += 4) {
  const [name, mime, ext, details] = tds.slice(i, i + 4);
  fileTypes.push({ name, mime, ext, details });
}

// console.log(fileTypes.find((ft) => ft.ext === ".js"));
console.log(fileTypes.find((ft) => ft.ext === ".md"));
fileTypes.push({
  name: "Markdown",
  mine: "text/markdown",
  ext: ".md",
  details: "a markup language",
});
console.log(fileTypes.find((ft) => ft.ext === ".md"));

const fs = require("fs");
const { extname } = require("path");
function walkDir(dir, boringPatterns) {
  function inner(rootDir) {
    return fs
      ...
      .map((f) => {
        ...
        if (
          boringPatterns &&
          boringPatterns.find((regexp) => regexp.test(f.name))
        ) {
          return;
        }
...
console.log(walkDir(".", [/^\./, /^node_modules$/, /^data$/]));

function countLines(path) {
  return fs.readFileSync(path, "utf8").trimRight().split("\n").length;
}

const result = new Map();
const paths = walkDir(".", [/^\./, /^node_modules$/, /^data$/]);
paths.forEach((path) => {
  const ext = extname(path);
  const found = fileTypes.find((ft) => ft.ext === ext);
  if (!found) {
    console.error("Ignore unkown extension", ext);
    return;
  }
  ...
  if (result.has(name)) {
    result.set(name, result.get(name) + lines);
  } else {
    result.set(name, lines);
  }
});
console.log(result);
